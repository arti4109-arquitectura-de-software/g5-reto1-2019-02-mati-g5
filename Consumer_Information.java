...
public class Consumer_Information implements ExceptionListener {
...
//            connection.close();   
    ...
    public static void main(String[] args) throws Exception{
    	Consumer_Information c = new Consumer_Information();
        System.out.println("Running Consumer for Informative Alerts");
        c.processConsumer();
    }
