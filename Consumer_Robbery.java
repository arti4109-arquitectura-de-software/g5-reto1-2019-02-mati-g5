...
public class Consumer_Robbery implements ExceptionListener {
...
//            connection.close();   
    ...
    public static void main(String[] args) throws Exception{
    	Consumer_Robbery c = new Consumer_Robbery();
        System.out.println("Running Consumer for Robbery Alerts");
        c.processConsumer();
    }
