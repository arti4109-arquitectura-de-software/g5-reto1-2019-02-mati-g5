...
public class Consumer_Ambulance implements ExceptionListener {
    ...
    MessageListener listener = new MessageListener() {
        ...
        public void onMessage(Message msg) {
            ...
            if (msg instanceof TextMessage) {
                ...
                System.out.println("Tipo de Alerta = " + msg);
            }
//            connection.close();   
        }
    };
    ...
    public static void main(String[] args) throws Exception{
    	Consumer_Ambulance c = new Consumer_Ambulance();
        System.out.println("Running Consumer for Accidents Alerts");
        c.processConsumer();
    }
