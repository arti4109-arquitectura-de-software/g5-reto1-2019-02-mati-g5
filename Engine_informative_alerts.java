...
public class Engine_informative_alerts {
	
    public static void main(String[] args) throws Exception{
    	System.out.println("Running Engine");
    	while (true) {
            thread(new Engine_informative(), false);
            thread(new Engine_informative(), false);
            thread(new Engine_informative(), false);
            thread(new Engine_informative(), false);
            thread(new Engine_informative(), false);
    ...
    public static class Engine_informative implements Runnable, ExceptionListener {
        public void run() {
        try {
            // URL of the JMS server
            //String url = ActiveMQConnection.DEFAULT_BROKER_URL;
            String url = "tcp://localhost:61616";
            String queue = "INFO_QUEUE";
