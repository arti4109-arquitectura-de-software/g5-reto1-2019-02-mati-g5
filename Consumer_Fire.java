...
public class Consumer_Fire implements ExceptionListener {
...
//            connection.close();   
    ...
    public static void main(String[] args) throws Exception{
    	Consumer_Fire c = new Consumer_Fire();
        System.out.println("Running Consumer for Fire Alerts");
        c.processConsumer();
    }
